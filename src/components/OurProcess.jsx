  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-gray-900 py-16 px-5">
      ...
      <div className="z-10 flex flex-col items-center w-full">
        ...
        <div className="flex flex-col items-center mx-auto my-0 max-w-6xl max-md:px-5 max-md:py-0 max-md:max-w-full max-sm:max-w-screen-sm">
          <div className="mb-6 text-5xl font-serif tracking-tighter leading-10 text-center text-white max-sm:text-3xl max-sm:leading-10">
            Our Proven Development Process
          </div>
          <div className="mb-10 max-w-screen-md text-xl leading-7 text-center text-gray-300 max-sm:text-lg max-sm:leading-6">
            A transparent, efficient journey from your initial idea to a
            market-ready MVP in just 5 weeks. Here's how we make it happen.
          </div>
          <div className="flex gap-8 mb-8 w-full max-md:flex-col max-sm:gap-5">
            <div className="flex flex-col flex-1 items-center p-6 rounded-3xl border border-blue-700 border-opacity-30 bg-gray-900 bg-opacity-70 backdrop-blur-sm hover:border-blue-500 transition-all duration-300 max-sm:p-5">
              <div className="flex justify-center items-center mb-4 w-16 h-16 rounded-full">
                <div>
                  <div
                    dangerouslySetInnerHTML={{
                      __html:
                        '<svg id="67:401" layer-name="SVG" width="41" height="40" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon" style="width: 40px; height: 40px"> <path d="M13.6636 3.33337V10" stroke="#60A5FA" stroke-width="3.33333" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M26.9966 3.33337V10" stroke="#60A5FA" stroke-width="3.33333" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M31.9967 6.66663H8.66341C6.82246 6.66663 5.33008 8.15901 5.33008 9.99996V33.3333C5.33008 35.1742 6.82246 36.6666 8.66341 36.6666H31.9967C33.8377 36.6666 35.3301 35.1742 35.3301 33.3333V9.99996C35.3301 8.15901 33.8377 6.66663 31.9967 6.66663Z" stroke="#60A5FA" stroke-width="3.33333" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M5.33008 16.6666H35.3301" stroke="#60A5FA" stroke-width="3.33333" stroke-linecap="round" stroke-linejoin="round"></path> </svg>',
                    }}
                  />
                </div>
              </div>
              ...
              <div className="text-base leading-6 text-center text-gray-300">
              ...
              <div className="flex justify-center items-center mb-4 w-16 h-16 rounded-full">
                <div>
                  <div
                    dangerouslySetInnerHTML={{
                      __html:
                        '<svg id="67:410" layer-name="SVG" width="41" height="40" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon" style="width: 40px; height: 40px"> <path d="M25.9801 3.33337H10.9801C10.096 3.33337 9.24816 3.68456 8.62304 4.30968C7.99792 4.93481 7.64673 5.78265 7.64673 6.66671V33.3334C7.64673 34.2174 7.99792 35.0653 8.62304 35.6904C9.24816 36.3155 10.096 36.6667 10.9801 36.6667H30.9801C31.8641 36.6667 32.712 36.3155 33.3371 35.6904C33.9622 35.0653 34.3134 34.2174 34.3134 33.3334V11.6667L25.9801 3.33337Z" stroke="#60A5FA" stroke-width="3.33333" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M24.3132 3.33337V10C24.3132 10.8841 24.6644 11.7319 25.2895 12.3571C25.9147 12.9822 26.7625 13.3334 27.6466 13.3334H34.3132" stroke="#60A5FA" stroke-width="3.33333" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M17.6466 15H14.3132" stroke="#60A5FA" stroke-width="3.33333" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M27.6466 21.6666H14.3132" stroke="#60A5FA" stroke-width="3.33333" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M27.6466 28.3334H14.3132" stroke="#60A5FA" stroke-width="3.33333" stroke-linecap="round" stroke-linejoin="round"></path> </svg>',
                    }}
                  />
                </div>
              </div>
              ...
              <div className="flex justify-center items-center mb-4 w-16 h-16 rounded-full">
                <div>
                  <div
                    dangerouslySetInnerHTML={{
                      __html:
                        '<svg id="67:426" layer-name="SVG" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon" style="width: 40px; height: 40px"> <path d="M12.5 7.1167L27.5 15.7" stroke="#60A5FA" stroke-width="3.33333" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M35 13.3334C34.9994 12.7488 34.8451 12.1747 34.5526 11.6686C34.26 11.1626 33.8396 10.7423 33.3333 10.45L21.6667 3.78337C21.1599 3.49081 20.5851 3.33679 20 3.33679C19.4149 3.33679 18.8401 3.49081 18.3333 3.78337L6.66667 10.45C6.16044 10.7423 5.73997 11.1626 5.44744 11.6686C5.1549 12.1747 5.0006 12.7488 5 13.3334V26.6667C5.0006 27.2512 5.1549 27.8254 5.44744 28.3314C5.73997 28.8375 6.16044 29.2578 6.66667 29.55L18.3333 36.2167C18.8401 36.5093 19.4149 36.6633 20 36.6633C20.5851 36.6633 21.1599 36.5093 21.6667 36.2167L33.3333 29.55C33.8396 29.2578 34.26 28.8375 34.5526 28.3314C34.8451 27.8254 34.9994 27.2512 35 26.6667V13.3334Z" stroke="#60A5FA" stroke-width="3.33333" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M5.5 11.6666L20 20L34.5 11.6666" stroke="#60A5FA" stroke-width="3.33333" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M20 36.6667V20" stroke="#60A5FA" stroke-width="3.33333" stroke-linecap="round" stroke-linejoin="round"></path> </svg>',
                    }}
                  />
                </div>
              </div>
