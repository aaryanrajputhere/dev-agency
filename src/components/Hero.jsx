    ...
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-black py-16 px-4 sm:px-6">
      ...
      >
        ...
        <div className="flex flex-col justify-center items-start text-left max-w-3xl w-full">
          ...
          <h2 className={`ml-1 text-xl sm:text-xl md:text-2xl font-light text-gray-400 italic font-serif transition-all duration-700 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '500ms' }}>
            that turn <span className="text-white font-medium">ideas</span> into <span className="text-gray-200 font-medium">income</span>
          </h2>
          
          <div className={`mt-5 text-3xl sm:text-3xl md:text-4xl lg:text-5xl font-serif tracking-wide text-gray-400 transition-all duration-700 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '700ms' }}>
            <span className="opacity-80">One Team</span>{" "}
            <span className="text-white italic border-b-2 border-white pb-1 relative hover:text-gray-200 hover:border-gray-200 transition-all duration-300">Real Results</span>
          </div>
          
          <p className={`mt-8 text-base sm:text-lg md:text-lg text-gray-500 leading-relaxed tracking-wide max-w-lg transition-all duration-700 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '900ms' }}>
        ...
        <div className={`flex-shrink-0 w-72 sm:w-80 md:w-80 lg:w-96 mt-12 lg:mt-0 mx-auto lg:mx-0 transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`} style={{ transitionDelay: '500ms' }}>
          ...
          <div className={`mt-4 text-left transition-all duration-700 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '800ms' }}>
...
{/*       
      ...
      <div className="absolute top-1/4 -left-16 sm:-left-32 w-32 sm:w-64 h-32 sm:h-64 bg-white rounded-full filter blur-3xl opacity-3 sm:opacity-5 animate-pulse-slow" style={{ animationDuration: '15s' }} />
      <div className="absolute bottom-1/4 -right-16 sm:-right-32 w-32 sm:w-64 h-32 sm:h-64 bg-white rounded-full filter blur-3xl opacity-3 sm:opacity-5 animate-pulse-slow" style={{ animationDuration: '12s', animationDelay: '2s' }} />
      <div className="absolute top-2/3 left-1/3 w-24 sm:w-48 h-24 sm:h-48 bg-white rounded-full filter blur-3xl opacity-2 sm:opacity-3 animate-pulse-slow" style={{ animationDuration: '20s', animationDelay: '5s' }} />
